...
namespace Illuminate\Support\Facades {use ;use Illuminate\Support\HtmlString;use Illuminate\View\Factory;use InvalidArgumentException;use ReflectionException;
    /**
     *
     *
    ...
    class Artisan
    {
         ...
         *
         * @internal
         * @return \App\System\Console\Kernel
         * @static
         */
        public static function rerouteSymfonyCommandEvents()
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel
            /** @var \App\System\Console\Kernel $instance */
    ...
    class Auth
    {
         ...
         *
         * @return \App\Users\Users\User|null
         * @static
         */
         ...
         *
         * @param mixed $id
         * @return \App\Users\Users\User|false
         * @static
         */
    ...
    class Schema
    {
        ...
        public static function useNativeSchemaOperationsIfPossible(
            ...
            //Method inherited from \Illuminate\Database\Schema\Builder
            \Illuminate\Database\Schema\MySqlBuilder::useNativeSchemaOperationsIfPossible(
                $value
            );
        }
        /**
...
namespace Aws\Laravel {use Aws\AwsClientInterface;use Aws\Sdk;use InvalidArgumentException;
    /**
    ...
    class AwsFacade
    {
        ...
        {
            return Sdk::getEndpointPrefix($name);
        }
    }
}
...
namespace Illuminate\Testing {use Illuminate\Http\Response;use Mockery\MockInterface;
    /**
     *
     *
     * @mixin Response
    ...
    class TestResponse
    {
        ...
        {
            return TestResponse::assertGraphQLValidationError(
                $key,
                $message
            );
        }
        ...
        {
            return TestResponse::assertGraphQLValidationKeys(
                $keys
            );
        }
        /**
        ...
        {
            return TestResponse::assertGraphQLValidationPasses();
        }
        /**
         *
         *
        ...
        {
            return TestResponse::assertGraphQLError($error);
        }
        /**
         *
         *
        ...
        {
            return TestResponse::assertGraphQLErrorMessage(
                $message
            );
        }
        /**
        ...
        {
            return TestResponse::assertGraphQLDebugMessage(
                $message
            );
        }
        /**
        ...
        {
            return TestResponse::assertGraphQLErrorFree();
        }
        /**
         *
         *
         ...
         */
        public static function assertGraphQLSubscriptionAuthorized(
            $testClassInstance
        ) {
            return TestResponse::assertGraphQLSubscriptionAuthorized(
                $testClassInstance
            );
        }
        /**
         ...
         */
        public static function assertGraphQLSubscriptionNotAuthorized(
            $testClassInstance
        ) {
            return TestResponse::assertGraphQLSubscriptionNotAuthorized(
                $testClassInstance
            );
        }
        /**
        ...
        {
            return TestResponse::graphQLSubscriptionMock();
        }
        /**
         *
         *
        ...
        {
            return TestResponse::graphQLSubscriptionChannelName();
        }
        /**
         *
         *
        ...
        {
            return TestResponse::assertGraphQLBroadcasted(
                $data
            );
        }
        /**
        ...
        {
            return TestResponse::assertGraphQLNotBroadcasted();
        }
    }
}

namespace {
    use ;use Aws\Laravel\AwsFacade;use Illuminate\Contracts\Database\Query\Expression;use Illuminate\Contracts\Pagination\CursorPaginator;use Illuminate\Contracts\Pagination\LengthAwarePaginator;use Illuminate\Contracts\Pagination\Paginator;use Illuminate\Contracts\Support\Arrayable;use Illuminate\Database\Eloquent\Model;use Illuminate\Database\Eloquent\ModelNotFoundException;use Illuminate\Database\Eloquent\RelationNotFoundException;use Illuminate\Database\Eloquent\Relations\MorphTo;use Illuminate\Database\Eloquent\Relations\Relation;use Illuminate\Database\Eloquent\Scope;use Illuminate\Database\Eloquent\TUnlessReturnType;use Illuminate\Database\Eloquent\TWhenReturnType;use Illuminate\Database\MultipleRecordsFoundException;use Illuminate\Database\Query\Builder;use Illuminate\Database\Query\Grammars\Grammar;use Illuminate\Database\Query\never;use Illuminate\Database\Query\Processors\Processor;use Illuminate\Database\RecordsNotFoundException;use Illuminate\Pagination\Cursor;use Illuminate\Support\Collection;use Illuminate\Support\LazyCollection;
